...
module.exports = {
  // Project Identity
  appName: "themewithtimber", // Unique name of your project
  type: "theme", // Plugin or theme
  slug: "themewithtimber", // Plugin or Theme slug, basically the directory name under `wp-content/<themes|plugins>`
  // Used to generate banners on top of compiled stuff
  bannerConfig: {
    name: "themewithtimber",
  ...
  watch: ["./(inc|includes)/**/*.php", "./**/*.twig", "./functions.php"],
